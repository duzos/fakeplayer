...
public class FollowOwnerGoal extends Goal {
	...
	private boolean tryTeleportTo(int x, int y, int z) {
		...
		this.entity.snapTo((double) x + 0.5D, (double) y, (double) z + 0.5D, this.entity.getYRot(), this.entity.getXRot());
		this.entity.getNavigation().stop();
		return true;
	}

	private boolean isTeleportFriendlyBlock(BlockPos pos) {
		PathType type = WalkNodeEvaluator.getPathTypeStatic(this.entity, pos);
