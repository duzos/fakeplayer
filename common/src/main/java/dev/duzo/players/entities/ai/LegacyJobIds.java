...
public final class LegacyJobIds {
	...
	private static final Identifier[] BY_ORDINAL = {
			id("none"),          // 0
			id("idle"),          // 1
			id("guard"),         // 2
			id("follow"),        // 3
	...
	private static final Map<String, Identifier> BY_NAME = new HashMap<>();
	private static final Map<Identifier, Integer> ORDINAL_OF = new HashMap<>();
	...
	private static Identifier id(String path) {
		return Identifier.fromNamespaceAndPath("players", path);
	}

	/** @return the identifier that legacy ordinal named, or null when the ordinal is unknown. */
	@Nullable
	public static Identifier byOrdinal(int ordinal) {
	...
	@Nullable
	public static Identifier byName(@Nullable String name) {
	 ...
	 */
	public static int ordinalOf(@Nullable Identifier id) {
