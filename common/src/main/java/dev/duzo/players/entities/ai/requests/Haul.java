...
public record Haul(UUID quartermaster, Identifier item, int baseline, long since) {
	...
	public static void write(FakePlayerEntity runner, UUID quartermaster, Identifier item, long now) {
	...
	public static void write(FakePlayerEntity runner, UUID quartermaster, Identifier item, int baseline, long since) {
