 ...
 */
@ApiStatus.Internal
public record Haul(UUID quartermaster, Identifier item, int baseline, long since) {
	 ...
	 */
	public static boolean write(FakePlayerEntity runner, UUID quartermaster, Identifier item, long now) {
	...
	public static boolean write(FakePlayerEntity runner, UUID quartermaster, Identifier item, int baseline, long since) {
