...
public class FPJobs {
	public static final ResourceKey<Registry<JobType>> REGISTRY_KEY =
			ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "job"));
	...
	private static final List<ResourceLocation> ORDER = new ArrayList<>();
